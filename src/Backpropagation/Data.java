...
public class Data {
    ...
    private double data [][] = new double[100][6];
    private double data_asli [][] = new double[100][6];
    private double [] dataa,m,v,s,k,e,tr;
    ...
    public Data(){
        ...
        try{
            ...
            while((res.next())){
                ...
                trr.add(res.getDouble("id_pengguna"));
...
*/
    ...
    public void setAllUji(double alfaa){
        ...
        String que = "insert into temp_y (y,t)"+" values (?,?)";
        ...
        try {
            ...
            PreparedStatement ins = konek.prepareStatement(que);
                    for (int l = 0; l < nilaiUjiAll.length; l++) {
                        ins.setDouble(1, nilaiUjiAll[l]);
                        ins.setDouble(2, target[l][5]);
                        ins.executeUpdate();
                    }
